...
class Garbage:
    ...
    def update_position(self, current_velocity, air_velocity, eddy_dispersion_velocity, alpha=[0.1,0.1]):
        new_velocity=[1,1]
...
def simulate_garbage_movement(garbage, current_velocity_field, air_velocity_field, map , time_steps):
    positions = []
    for i in range(time_steps):
        ...
        garbage.update_position(current_velocity, air_velocity, eddy_dispersion_velocity)
...
positions = simulate_garbage_movement(garbage, current_velocity_field, air_velocity_field, map , 100)    # 100 - no of time steps
